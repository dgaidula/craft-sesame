...
- **NEXT: P1.2 named codes** (largest/most security-critical — verify loop over N codes, session 'c' slot, per-code revoke/expiry, codeId on log, per-code magic links, code-management CP UI), then P1.3 branding.
