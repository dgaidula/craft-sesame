...
- **NEXT: P1.3 branding** (CP-editable challenge screen: logo/heading/intro/accent; site default + per-rule override; stored in a plugin table so editable on prod; challenge.twig reads it). Last P1 feature. Then P2 on demand.
